    ...
    <Grid item md={6} xs={12}>
     ...
     <form noValidate>
      <Grid container spacing={2}>
       <Grid item xs={12}>
        <TextField type="name" name="stuname"  id="stuname" label="Song Name" onChange={e => onTextFieldChange(e)}
        />
       </Grid>

       <Grid item xs={12}>
        <TextField type="date" name="date"  id="date" label="" onChange={e => onTextFieldChange(e)}
        />
       </Grid>
